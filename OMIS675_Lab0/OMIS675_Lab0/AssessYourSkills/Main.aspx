<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Main.aspx.cs" Inherits="OMIS675_Lab0.AssessYourSkills.Main" %>
...
<body>
                    ...
                    <article class="col-3-4">
                        <div class="wrap-col">
                            ...
                            <div class="wrapper pad_bot1">
                                ...
                                <p class="pad_bot1">
                                    May 16, 2011<br>
                                    <strong class="color1">Lorem ipsum dolor sit amet consectetur adipiscing</strong>
                                </p>
                                <p>
                            ...
                            <div class="wrapper">
                                ...
                                <p class="pad_bot1">
                                    May 12, 2011<br>
                                    <strong class="color1">Libero mauris varius mivitae suscipit ipsum</strong>
                                </p>
                                <p>
            ...
            <div class="main zerogrid">
                ...
                <section class="content">
                    ...
                    <article class="col-1-3">
                        <h2>Our Location</h2>
                        <p>
                            Company Name Inc. 8901 Marmora<br>
                            Road,Glasgow, D04 89GR.
                        </p>
                        <p>
                            <span class="right">+1 800 559 6580</span><strong class="color1">Freephone:</strong><br>
                            ...
                            <span class="right"><a href="mailto:">mail@business.com</a></span>	<strong class="color1">E-mail:</strong>
                        </p>
                    </article>
                </section>
                <!--content end-->
    ...
    <div class="main zerogrid">
        ...
        <footer class="footer_end">
            ...
            <a rel="nofollow" href="http://www.templatesmonster.com/" target="_blank">Free HTML5 Templates</a> designed by TemplateMonster.com<br><a rel="nofollow" href="http://www.zerotheme.com/432/free-responsive-html5-css3-website-templates.html" target="_blank">Free Responsive Themes</a> designed by <a href="http://www.zerotheme.com" target="_blank">Zerotheme.com</a>
        </footer>
        <!--footer end-->
    </div>
